    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogTitle" width="800px">
      <el-form ref="formRef" :model="form" label-width="120px">
        ...
        <el-form-item label="巡检时间" :rules="{ required: true, message: '请选择巡检时间', trigger: 'change' }">
          <el-date-picker v-model="form.displayTime" type="datetime" placeholder="选择日期时间" :picker-options="{
            shortcuts: false,
...
export default {
  ...
  methods: {
    ...
    detail(row) {
      ...
      // 根据当前行的状态和巡查时间动态更新 processVoList
