  ...
  <div class="mod-menu">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <!-- <div>{{ scope.row }}</div> -->
          <el-button round v-if="scope.row.operatorStatus == 1 " type="primary" size="mini" @click="showwarninginfor(scope.row.recordId,scope.row.equipmentId,false)">处理</el-button>
          <el-button round v-if="scope.row.operatorStatus == 0 " type="success" size="mini" @click="showwarninginfor(scope.row.recordId,scope.row.equipmentId,true)">详情</el-button>
          <el-button round  type="danger" size="mini" @click="deleteHandle(scope.row.recordId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
