package com.example.image_label.Generator;
...
public class Generator {
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/image_annotation?serverTimezone=Asia/Shanghai", "root", "123456")
                .globalConfig(builder -> {
                    builder.author("lzf")// 设置作者
                ...
                .packageConfig(builder -> {//设置包名
                    builder.parent("com.example.image_label") // 设置父包名
                            .entity("pojo")//设置实体类包名，默认值:entity
                            .mapper("dao");//默认值:mapper
                })
                .strategyConfig(builder -> {
                    builder.addInclude("t_label") // 设置需要生成的表名
