...
public class EquipmentController {
    ...
    public R info(@PathVariable("equipmentId") String equipmentId){
		...
		LocationEntity locationEntity = locationService.selectById(cfEquipment.getLocaltionId());
		if (locationEntity != null) {
			cfEquipment.setProvince(locationEntity.getProvince());
			cfEquipment.setCitycode(locationEntity.getCitycode());
			cfEquipment.setCity(locationEntity.getCity());
			cfEquipment.setDistrict(locationEntity.getDistrict());
		}
